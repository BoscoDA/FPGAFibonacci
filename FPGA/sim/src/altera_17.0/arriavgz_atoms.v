...
primitive ARRIAVGZ_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive ARRIAVGZ_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive ARRIAVGZ_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module arriavgz_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   ARRIAVGZ_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module arriavgz_mux21 (MO, A, B, S);
   input A, B, S;
   output MO;
...
module arriavgz_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
module arriavgz_bmux21 (MO, A, B, S);
   input [15:0] A, B;
   input 	S;
   output [15:0] MO; 
...
module arriavgz_b17mux21 (MO, A, B, S);
   input [16:0] A, B;
   input 	S;
   output [16:0] MO; 
...
module arriavgz_nmux21 (MO, A, B, S);
   input A, B, S; 
   output MO; 
...
module arriavgz_b5mux21 (MO, A, B, S);
   input [4:0] A, B;
   input       S;
   output [4:0] MO; 
...
//------------------------------------------------------------------
//
// Module Name : arriavgz_ff
//
// Description : ARRIAVGZ FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
parameter lpm_type = "arriavgz_ff";
...
//------------------------------------------------------------------
//
// Module Name : arriavgz_lcell_comb
//
// Description : ARRIAVGZ LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for arriavgz_lcell_comb.v
...
parameter lpm_type = "arriavgz_lcell_comb";
...
//------------------------------------------------------------------
//
// Module Name : arriavgz_routing_wire
//
...
endmodule // arriavgz_routing_wire
// Deactivate the following LEDA rules for arriavgz_ram_block.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
...
//--------------------------------------------------------------------------
// Module Name     : arriavgz_ram_block
// Description     : Main RAM module
//--------------------------------------------------------------------------

module arriavgz_ram_block
    (
     portadatain,
     portaaddr,
     portawe,
...
parameter lpm_type = "arriavgz_ram_block";
...
//--------------------------------------------------------------------------
// Module Name     : arriavgz_mlab_cell
// Description     : Main RAM module
//--------------------------------------------------------------------------

// Deactivate the following LEDA rules for arriavgz_lutram_block.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off

`timescale 1 ps/1 ps

module arriavgz_mlab_cell
    (
     portadatain,
     portaaddr, 
     portabyteenamasks, 
...
parameter lpm_type = "arriavgz_mlab_cell";
parameter lpm_hint = "true";
...
endmodule // arriavgz_mlab_cell

// Re-activate the LEDA rules
// leda G_521_3_B on
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriavgz_io_ibuf                                 //
//Description:                    Simulation model for ARRIAVGZ IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for arriavgz_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
parameter lpm_type = "arriavgz_io_ibuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriavgz_io_obuf                                 //
//Description:                    Simulation model for ARRIAVGZ IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

module arriavgz_io_obuf (
                      i,
                      oe,
                      dynamicterminationcontrol,      
...
parameter lpm_type = "arriavgz_io_obuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriavgz_ddio_out                                //
//Description:                    Simulation model for ARRIAVGZ DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

module arriavgz_ddio_out (
                        datainlo,
                        datainhi,
                        clk,
                        clkhi,
...
parameter lpm_type = "arriavgz_ddio_out";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriavgz_ddio_oe                                 //
//Description:                    Simulation model for ARRIAVGZ DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
module arriavgz_ddio_oe (
                       oe,
                       clk,
                       ena,
                       areset,
...
parameter async_mode = "none";
parameter sync_mode = "none";
parameter lpm_type = "arriavgz_ddio_oe";
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriavgz_ddio_in                                 
//Description:                    Simulation model for ARRIAVGZ DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
                                                                                
                                                                                
module arriavgz_ddio_in (                                                          
                      datain,                                                   
                      clk,                                                      
                      clkn,                                                     
                      ena,                                                      
...
parameter lpm_type = "arriavgz_ddio_in";                                           
...
module arriavgz_io_pad ( 
		      padin, 
                      padout
	            );

parameter lpm_type = "arriavgz_io_pad";
//INPUT PORTS
...
module arriavgz_pseudo_diff_out(
                             i,
                             o,
                             obar,
// ports new for ARRIAVGZ
				dtcin,
				dtc,
				dtcbar,
				oein,
...
parameter lpm_type = "arriavgz_pseudo_diff_out";
...
// -----------------------------------------------------------
//
// Module Name : arriavgz_bias_logic
//
...
endmodule // arriavgz_bias_logic

// -----------------------------------------------------------
//
// Module Name : arriavgz_bias_generator
//
// Description : ARRIAVGZ Bias Generator Verilog simulation model
//
// -----------------------------------------------------------

`timescale 1 ps/1 ps

module arriavgz_bias_generator (
    din,
    mainclk,
    updateclk,
    capture,
...
endmodule // arriavgz_bias_generator

// -----------------------------------------------------------
//
// Module Name : arriavgz_bias_block
//
// Description : ARRIAVGZ Bias Block Verilog simulation model
//
// -----------------------------------------------------------

`timescale 1 ps/1 ps

module arriavgz_bias_block(
			clk,
			shiftnld,
			captnupdt,
			din,
...
parameter lpm_type = "arriavgz_bias_block";
...
arriavgz_bias_logic logic_block (
                             .clk(clk),
                             .shiftnld(shiftnld),
                             .captnupdt(captnupdt),
...
arriavgz_bias_generator bias_generator (
                                    .din(din),
                                    .mainclk(mainclk_wire),
                                    .updateclk(updateclk_wire),
                                    .capture(capture_wire),
...
endmodule // arriavgz_bias_block

///////////////////////////////////////////////////////////////////////////////
//  Module Name:             arriavgz_mac                                    //
...
//PARAMETERS
parameter lpm_type = "arriavgz_mac";
...
arriavgz_mac_encrypted	mac_core0
(
	.sub(sub),
	.negate(negate),
...
module    arriavgz_clk_phase_select    (
    clkin,
    phasectrlin,
    phaseinvertctrl,
    powerdown,
    ...
    arriavgz_clk_phase_select_encrypted inst (
        .clkin(clkin),
...
endmodule //arriavgz_clk_phase_select

`timescale 1 ps/1 ps

module    arriavgz_clkena    (
    inclk,
    ena,
    enaout,
    outclk);
...
// leda G_521_3_B off
    ...
    parameter    lpm_type    =    "arriavgz_clkena";
...
// leda G_521_3_B on
    ...
    arriavgz_clkena_encrypted inst (
        .inclk(inclk),
        .ena(ena),
        .enaout(enaout),
        .outclk(outclk) );
...
endmodule //arriavgz_clkena

`timescale 1 ps/1 ps

module    arriavgz_clkselect    (
    inclk,
    clkselect,
    outclk);

// leda G_521_3_B off
    parameter    lpm_type    =    "arriavgz_clkselect";
...
// leda G_521_3_B on
    ...
    arriavgz_clkselect_encrypted inst (
        .inclk(inclk),
        .clkselect(clkselect),
        .outclk(outclk) );
    defparam inst.lpm_type = lpm_type;
...
endmodule //arriavgz_clkselect

`timescale 1 ps/1 ps

module    arriavgz_delay_chain    (
    datain,
    delayctrlin,
    dataout);
    ...
    parameter    lpm_type    =    "arriavgz_delay_chain";
    ...
    arriavgz_delay_chain_encrypted inst (
        .datain(datain),
...
endmodule //arriavgz_delay_chain

`timescale 1 ps/1 ps

module    arriavgz_dll_offset_ctrl    (
    clk,
    offsetdelayctrlin,
    offset,
    addnsub,
    ...
    arriavgz_dll_offset_ctrl_encrypted inst (
        .clk(clk),
...
endmodule //arriavgz_dll_offset_ctrl
...
module    arriavgz_dll    (
    ...
    parameter    lpm_type    =    "arriavgz_dll";
...
endmodule //arriavgz_dll

`timescale 1 ps/1 ps

module    arriavgz_dqs_config    (
    datain,
  	clk,
  	ena,
  	update,
    ...
    parameter    lpm_type    =    "arriavgz_dqs_config";
    ...
    arriavgz_dqs_config_encrypted inst (
    	.datain(datain),
  		.clk(clk),
  		.ena(ena),
  		.update(update),
...
endmodule //arriavgz_dqs_config

`timescale 1 ps/1 ps

module    arriavgz_dqs_delay_chain    (
    dqsin,
    dqsenable,
    dqsdisablen,
    delayctrlin,
    ...
    arriavgz_dqs_delay_chain_encrypted inst (
        .dqsin(dqsin),
        .dqsenable(dqsenable),
        .delayctrlin(delayctrlin),
...
endmodule //arriavgz_dqs_delay_chain

`timescale 1 ps/1 ps

module    arriavgz_dqs_enable_ctrl    (
    dqsenablein,
    zerophaseclk,
    enaphasetransferreg,
    levelingclk,
    ...
    arriavgz_dqs_enable_ctrl_encrypted inst (
...
endmodule //arriavgz_dqs_enable_ctrl

`timescale 1 ps/1 ps

module    arriavgz_duty_cycle_adjustment    (
    clkin,
    delaymode,
    delayctrlin,
    clkout);
    ...
    parameter    lpm_type    =    "arriavgz_duty_cycle_adjustment";
    ...
    arriavgz_duty_cycle_adjustment_encrypted inst (
        .clkin(clkin),
        .delaymode(delaymode),
        .delayctrlin(delayctrlin),
        .clkout(clkout) );
...
endmodule //arriavgz_duty_cycle_adjustment

`timescale 1 ps/1 ps
module arriavgz_fractional_pll
#(
...
//input and output port declaration
	...
	arriavgz_fractional_pll_encrypted 
	#(
	...
	arriavgz_fractional_pll_encrypted_inst	(
		.cntnen(cntnen),
		.coreclkfb(coreclkfb),
		.ecnc1test(ecnc1test),
		.ecnc2test(ecnc2test),
...
`timescale 1 ps/1 ps
module arriavgz_pll_dll_output
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriavgz_pll_dll_output_encrypted 
	#(
		.pll_dll_src(pll_dll_src)

	)
	arriavgz_pll_dll_output_encrypted_inst	(
		.cclk(cclk),
		.clkin(clkin),
		.clkout(clkout)
	);
...
`timescale 1 ps/1 ps
module arriavgz_pll_dpa_output
#(
	// parameter declaration and default value assignemnt
	parameter output_clock_frequency = "",	//Valid values: 
...
//input and output port declaration
	...
	arriavgz_pll_dpa_output_encrypted 
	#(
		.output_clock_frequency(output_clock_frequency),
		.pll_vcoph_div(pll_vcoph_div)

	)
	arriavgz_pll_dpa_output_encrypted_inst	(
		.pd(pd),
		.phin(phin),
		.phout(phout)
	);
...
`timescale 1 ps/1 ps
module arriavgz_pll_extclk_output
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriavgz_pll_extclk_output_encrypted 
	#(
	...
	arriavgz_pll_extclk_output_encrypted_inst	(
		.cclk(cclk),
		.clken(clken),
		.mcnt0(mcnt0),
		.mcnt1(mcnt1),
...
`timescale 1 ps/1 ps
module arriavgz_pll_lvds_output
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriavgz_pll_lvds_output_encrypted 
	#(
	...
	arriavgz_pll_lvds_output_encrypted_inst	(
		.ccout(ccout),
		.loaden(loaden),
		.lvdsclk(lvdsclk)
	);
...
`timescale 1 ps/1 ps
module arriavgz_pll_output_counter
#(
	// parameter declaration and default value assignemnt
	parameter output_clock_frequency = "",	//Valid values: 
...
//input and output port declaration
	...
	arriavgz_pll_output_counter_encrypted 
	#(
		.output_clock_frequency(output_clock_frequency),
	...
	arriavgz_pll_output_counter_encrypted_inst	(
		.cascadein(cascadein),
		.nen0(nen0),
		.nen1(nen1),
		.shift0(shift0),
...
//input and output port declaration
	...
	arriavgz_pll_reconfig_encrypted 
	#(
		.fractional_pll_index(fractional_pll_index)
	) 
	arriavgz_pll_reconfig_encrypted_inst (
		.addr(addr),
        .atpgmode ( atpgmode ),
		.byteen(byteen),
		.clk(clk),
...
`timescale 1 ps/1 ps
module arriavgz_pll_refclk_select
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriavgz_pll_refclk_select_encrypted 
	#(
	...
	arriavgz_pll_refclk_select_encrypted_inst	(
		.adjpllin(adjpllin),
		.cclk(cclk),
		.clkin(clkin),
		.coreclkin(coreclkin),
...
module    arriavgz_half_rate_input    (
    datain,
    directin,
    clk,
    areset,
    ...
    arriavgz_half_rate_input_encrypted inst (
        .datain(datain),
        .directin(directin),
        .clk(clk),
        .areset(areset),
...
endmodule //arriavgz_half_rate_input

`timescale 1 ps/1 ps

module    arriavgz_input_phase_alignment    (
    datain,
    levelingclk,
    zerophaseclk,
    areset,
    ...
    parameter    bypass_output_register    =    "false";
    parameter    add_phase_transfer_reg    =    "false";
    parameter    lpm_type    =    "arriavgz_input_phase_alignment";
    ...
    arriavgz_input_phase_alignment_encrypted inst (
        .datain(datain),
        .levelingclk(levelingclk),
        .zerophaseclk(zerophaseclk),
        .areset(areset),
...
endmodule //arriavgz_input_phase_alignment

`timescale 1 ps/1 ps

module    arriavgz_io_clock_divider    (
    clk,
    phaseinvertctrl,
    masterin,
    clkout,
    ...
    parameter    lpm_type    =    "arriavgz_io_clock_divider";
    ...
    arriavgz_io_clock_divider_encrypted inst (
        .clk(clk),
        .phaseinvertctrl(phaseinvertctrl),
        .masterin(masterin),
        .clkout(clkout),
...
endmodule //arriavgz_io_clock_divider

`timescale 1 ps/1 ps

module    arriavgz_io_config    (
    datain,
    clk,
    ena,
    update,
    ...
    parameter    lpm_type    =    "arriavgz_io_config";
    ...
    arriavgz_io_config_encrypted inst (
        .datain(datain),
        .clk(clk),
        .ena(ena),
        .update(update),
...
endmodule //arriavgz_io_config

`timescale 1 ps/1 ps

module    arriavgz_leveling_delay_chain    (
    clkin,
    delayctrlin,
    clkout);
    ...
    arriavgz_leveling_delay_chain_encrypted inst (
        .clkin(clkin),
        .delayctrlin(delayctrlin),
        .clkout(clkout) );
...
endmodule //arriavgz_leveling_delay_chain

`timescale 1 ps/1 ps

module    arriavgz_lvds_rx    (
    clock0,
    datain,
    enable0,
    dpareset,
    ...
    parameter    lpm_type    =    "arriavgz_lvds_rx";
    ...
    arriavgz_lvds_rx_encrypted inst (
        .clock0(clock0),
        .datain(datain),
        .enable0(enable0),
        .dpareset(dpareset),
...
endmodule //arriavgz_lvds_rx

`timescale 1 ps/1 ps

module    arriavgz_lvds_tx    (
    datain,
    clock0,
    enable0,
    serialdatain,
	...
	parameter 	 enable_clock_pin_mode   = "false";
    parameter    lpm_type    =    "arriavgz_lvds_tx";
    parameter    data_width    =    10;
    ...
    arriavgz_lvds_tx_encrypted inst (
        .datain(datain),
        .clock0(clock0),
        .enable0(enable0),
...
endmodule //arriavgz_lvds_tx

`timescale 1 ps/1 ps

module    arriavgz_output_alignment    (
    datain,
    clk,
    areset,
    sreset,
    ...
    arriavgz_output_alignment_encrypted inst (
        .datain(datain),
        .clk(clk),
        .areset(areset),
        .sreset(sreset),
...
endmodule //arriavgz_output_alignment

`timescale 1 ps/1 ps

module    arriavgz_termination_logic    (
    s2pload,
    serdata,
    scanenable,
    scanclk,
    ...
    parameter    lpm_type    =    "arriavgz_termination_logic";
    ...
    arriavgz_termination_logic_encrypted inst (
        .s2pload(s2pload),
        .serdata(serdata),
...
endmodule //arriavgz_termination_logic

`timescale 1 ps/1 ps

module    arriavgz_termination    (
    rzqin,
    enserusr,
    nclrusr,
    clkenusr,
    ...
    parameter lpm_type = "arriavgz_termination";
    ...
    arriavgz_termination_encrypted inst (
        .rzqin(rzqin),
	.enserusr(enserusr),
    	.nclrusr(nclrusr),
    	.clkenusr(clkenusr),
...
endmodule //arriavgz_termination
...
module    arriavgz_asmiblock    (
    ...
    parameter    lpm_type    =    "arriavgz_asmiblock";
    ...
    arriavgz_asmiblock_encrypted inst (
        .dclk(dclk),
        .sce(sce),
        .oe(oe),
        .data0out(data0out),
...
endmodule //arriavgz_asmiblock

`timescale 1 ps/1 ps

module    arriavgz_chipidblock    (
    clk,
    shiftnld,
    regout);

    parameter    lpm_type    =    "arriavgz_chipidblock";
    ...
    arriavgz_chipidblock_encrypted inst (
        .clk(clk),
        .shiftnld(shiftnld),
        .regout(regout) );
    defparam inst.lpm_type = lpm_type;
...
endmodule //arriavgz_chipidblock

`timescale 1 ps/1 ps

module    arriavgz_controller    (
    nceout);

    parameter    lpm_type    =    "arriavgz_controller";


    output    nceout;

    arriavgz_controller_encrypted inst (
        .nceout(nceout) );
    defparam inst.lpm_type = lpm_type;

endmodule //arriavgz_controller

`timescale 1 ps/1 ps

module    arriavgz_crcblock    (
    clk,
    shiftnld,
    crcerror,
    regout,
    ...
    parameter    lpm_type    =    "arriavgz_crcblock";
    ...
    arriavgz_crcblock_encrypted inst (
        .clk(clk),
        .shiftnld(shiftnld),
        .crcerror(crcerror),
        .regout(regout),
...
endmodule //arriavgz_crcblock

`timescale 1 ps/1 ps

module    arriavgz_jtag    (
    tms,
    tck,
    tdi,
    ntrst,
    ...
    parameter    lpm_type    =    "arriavgz_jtag";
...
endmodule //arriavgz_jtag

`timescale 1 ps/1 ps

module    arriavgz_prblock    (
    clk,
    corectl,
    prrequest,
    data,
    ...
    parameter    lpm_type    =    "arriavgz_prblock";
    ...
    arriavgz_prblock_encrypted inst (
        .clk(clk),
        .corectl(corectl),
        .prrequest(prrequest),
        .data(data),
...
endmodule //arriavgz_prblock

`timescale 1 ps/1 ps

module    arriavgz_rublock    (
    clk,
    shiftnld,
    captnupdt,
    regin,
    ...
    parameter    lpm_type    =    "arriavgz_rublock";
    ...
    arriavgz_rublock_encrypted inst (
        .clk(clk),
        .shiftnld(shiftnld),
        .captnupdt(captnupdt),
        .regin(regin),
...
endmodule //arriavgz_rublock

`timescale 1 ps/1 ps

module    arriavgz_tsdblock    (
    clk,
    ce,
    clr,
    tsdcalo,
    ...
    parameter    lpm_type    =    "arriavgz_tsdblock";
    ...
    arriavgz_tsdblock_encrypted inst (
        .clk(clk),
        .ce(ce),
        .clr(clr),
        .tsdcalo(tsdcalo),
...
endmodule //arriavgz_tsdblock

`timescale 1 ps/1 ps

module arriavgz_read_fifo (
                           datain,
                           wclk,
                           we,
                           rclk,
    ...
    arriavgz_read_fifo_encrypted inst (
    	.datain(datain),
        .wclk(wclk),
        .we(we),
        .rclk(rclk),
...
endmodule //arriavgz_read_fifo

`timescale 1 ps/1 ps

module arriavgz_read_fifo_read_enable (
                           re,
                           rclk,
                           plus2,
                           areset,
    ...
    arriavgz_read_fifo_read_enable_encrypted inst (
    	.re(re),
    	.rclk(rclk),
    	.plus2(plus2),
    	.areset(areset),
...
endmodule //arriavgz_read_fifo_read_enable

`timescale 1 ps/1 ps

module arriavgz_phy_clkbuf (
                           inclk,
                           outclk
                          );
    ...
    arriavgz_phy_clkbuf_encrypted inst (
    	.inclk(inclk),
    	.outclk(outclk));
...
endmodule //arriavgz_phy_clkbuf_atom

`timescale 1 ps/1 ps

module    arriavgz_oscillator    (
    oscena,
    clkout,
    clkout1);
    ...
    arriavgz_oscillator_encrypted inst (
        .oscena(oscena),
        .clkout(clkout),
        .clkout1(clkout1));
        
endmodule //arriavgz_oscillator
