...
//
// Description : Twentynm PRBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
`timescale 1 ps/1 ps
module  twentynm_prblock 
	...
	localparam [3:0] PRBLOCK_INIT = 0,
					 PRBLOCK_RECEIVE_DATA = 1,
					 PRBLOCK_ASSERT_DONE_AND_DEASSERT_READY = 2,
					 PRBLOCK_DEASSERT_DONE = 3,
                     PRBLOCK_ASSERT_ERROR = 4,
					 PRBLOCK_DEASSERT_READY = 5,
					 PRBLOCK_DEASSERT_ERROR = 6,
                     PRBLOCK_ASSERT_ERROR_FOR_LATE_WITHDRAWAL = 7,
					 PRBLOCK_DEASSERT_ERROR_AND_READY_FOR_LATE_WITHDRAWAL = 8;
                    ...
                    case (data_count)
                        ...
                        begin
                            if (count == (CDRATIO-1)) begin
                                ...
                                if (data == 32'b0) begin
                                    // Allow initial data to be 0
                                    data_count <= PRDATA_COUNT_0;
                                end
                                else if (data == PARAM_DATA_0) begin
