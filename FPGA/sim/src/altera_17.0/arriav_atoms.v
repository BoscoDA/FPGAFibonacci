...
//------------------------------------------------------------------
//
// Module Name : arriav_routing_wire
//
...
//input and output port declaration
	...
	arriav_pll_reconfig_encrypted 
	#(
		.fractional_pll_index(fractional_pll_index)
	) 
	arriav_pll_reconfig_encrypted_inst
	(
		.addr(addr),
        .atpgmode ( atpgmode ),
		.byteen(byteen),
...
module    arriav_oscillator    (
    ...
    arriav_oscillator_encrypted inst (
        .oscena(oscena),
        .clkout(clkout),
        .clkout1(clkout1));
        
endmodule //arriav_oscillator


module arriav_hps_interface_fpga2sdram (
...
endmodule // arriav_hps_interface_fpga2sdram
