...
// Module Name : ./sim_model_wrappers//arriavgz_channel_pll_wrapper.v
// --------------------------------------------------------------------

`timescale 1 ps/1 ps
module arriavgz_channel_pll
#(      
...
//input and output port declaration
	...
	arriavgz_channel_pll_encrypted 
	#(
	...
	arriavgz_channel_pll_encrypted_inst	(
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : ./sim_model_wrappers//arriavgz_hssi_pma_aux_wrapper.v
// --------------------------------------------------------------------

`timescale 1 ps/1 ps
module arriavgz_hssi_pma_aux
#(
	parameter silicon_rev = "reve",      // Valid values: reve|es
  // 	// parameter declaration and default value assignemnt
	parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
//input and output port declaration
	...
	arriavgz_hssi_pma_aux_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriavgz_hssi_pma_aux_encrypted_inst	(
		.calpdb(calpdb),
		.calclk(calclk),
		.testcntl(testcntl),
		.refiqclk(refiqclk),
...
// Module Name : arriavgz_hssi_avmm_interface
// ----------------------------------------------------------------------------------

`timescale 1 ps/1 ps
module arriavgz_hssi_avmm_interface
  #(
...
//input and output port declaration
  ...
  arriavgz_hssi_avmm_interface_encrypted
  #(
    .num_ch0_atoms(num_ch0_atoms),
    .num_ch1_atoms(num_ch1_atoms),
    .num_ch2_atoms(num_ch2_atoms)
  ) arriavgz_hssi_avmm_interface_encrypted_inst (
    .avmmrstn          (avmmrstn),
    .avmmclk           (avmmclk),
    .avmmwrite         (avmmwrite),
    .avmmread          (avmmread),
...
`timescale 1 ps / 1 ps
module arriavgz_hssi_aux_clock_div (
    clk,     // input clock
    reset,   // reset
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_10g_rx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------

`timescale 1 ps/1 ps
module arriavgz_hssi_10g_rx_pcs
#(
  	parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	// This function also exists in arriavgz_hssi_10g_tx_pcs_wrapper_multirev.v
	...
	initial
	begin
		$display("module arriavgz_hssi_10g_rx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		...
		begin
			arriavgz_hssi_10g_rx_pcs_encrypted_ES #(
				.enable_debug_info(enable_debug_info),				
			...
			) arriavgz_hssi_10g_rx_pcs_encrypted_ES_inst (
				.rxprbserr(rxprbserr),
		...
		begin
			arriavgz_hssi_10g_rx_pcs_encrypted #(
				.enable_debug_info(enable_debug_info),
				.stretch_en(stretch_en),
				.rxfifo_empty(rxfifo_empty),
				.rx_sm_pipeln(rx_sm_pipeln),
				...
				.bitslip_mode(bitslip_mode),
				.rx_sm_bypass(rx_sm_bypass)
			) arriavgz_hssi_10g_rx_pcs_encrypted_inst (
				.rxprbserr(rxprbserr),
				.rxrdpossts(rxrdpossts),
				.rxprbsdone(rxprbsdone),
				.rxclkiqout(rxclkiqout),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_10g_tx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_10g_tx_pcs
#(
  	parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	// Function to convert a 64bit binary to a string
	// This function also exists in arriavgz_hssi_10g_rx_pcs_wrapper_multirev.v
	function [64*8-1 : 0] m_bin_to_str;
	    input	[64 : 1]	s;
	...
	initial
	begin
		$display("module arriavgz_hssi_10g_tx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_10g_tx_pcs_encrypted_ES #(
				.enable_debug_info(enable_debug_info),
				.stretch_en(stretch_en),
			...
			) arriavgz_hssi_10g_tx_pcs_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_10g_tx_pcs_encrypted #(
				.enable_debug_info(enable_debug_info),
				.stretch_en(stretch_en),
				.dispgen_pipeln(dispgen_pipeln),
				.pseudo_seed_a_user(pseudo_seed_a_user_string),
				...
				.prot_mode(prot_mode),
				.frmgen_clken(frmgen_clken)
			) arriavgz_hssi_10g_tx_pcs_encrypted_inst (
				.txfifopartialfull(txfifopartialfull),
				.txclkout(txclkout),
				.distdwninrdpfull(distdwninrdpfull),
				.distdwnoutwren(distdwnoutwren),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_8g_pcs_aggregate_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_8g_pcs_aggregate
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_8g_pcs_aggregate : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_8g_pcs_aggregate_encrypted_ES #(
				.user_base_address(user_base_address),
				...
				.agg_pwdn(agg_pwdn)
			) arriavgz_hssi_8g_pcs_aggregate_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_8g_pcs_aggregate_encrypted #(
				.user_base_address(user_base_address),
				.dskw_mnumber_data(dskw_mnumber_data),
				.use_default_base_address(use_default_base_address),
				.data_agg_bonding(data_agg_bonding),
				...
				.refclkdig_sel(refclkdig_sel),
				.agg_pwdn(agg_pwdn)
			) arriavgz_hssi_8g_pcs_aggregate_encrypted_inst (
				.latencycompinch0(latencycompinch0),
				.insertincompleteintopch0(insertincompleteintopch0),
				.delcondmet0ch1(delcondmet0ch1),
				.alignstatussync0botch2(alignstatussync0botch2),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_8g_rx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_8g_rx_pcs
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_8g_rx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_8g_rx_pcs_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
			...
			) arriavgz_hssi_8g_rx_pcs_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_8g_rx_pcs_encrypted #(
                .enable_debug_info(enable_debug_info),
				.fixed_pat_det(fixed_pat_det),
				.byte_deserializer(byte_deserializer),
				.polinv_8b10b_dec(polinv_8b10b_dec),
				...
				.clock_gate_dw_rm_wr(clock_gate_dw_rm_wr),
				.runlength_check(runlength_check)
			) arriavgz_hssi_8g_rx_pcs_encrypted_inst (
				.speedchangeinchnldown(speedchangeinchnldown),
				.fiforstrdqd(fiforstrdqd),
				.rmfifouserrst(rmfifouserrst),
				.rxstatus(rxstatus),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_8g_tx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_8g_tx_pcs
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
	parameter clock_gate_bist = "dis_bist_clk_gating",      // Valid values: dis_bist_clk_gating|en_bist_clk_gating
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_8g_tx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_8g_tx_pcs_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
				.clock_gate_bist(clock_gate_bist),
				...
				.prbs_gen(prbs_gen)
			) arriavgz_hssi_8g_tx_pcs_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_8g_tx_pcs_encrypted #(
                .enable_debug_info(enable_debug_info),
				.clock_gate_bist(clock_gate_bist),
				.clock_gate_bs_enc(clock_gate_bs_enc),
				.ctrl_plane_bonding_compensation(ctrl_plane_bonding_compensation),
				...
				.tx_compliance_controlled_disparity(tx_compliance_controlled_disparity),
				.prbs_gen(prbs_gen)
			) arriavgz_hssi_8g_tx_pcs_encrypted_inst (
				.polinvrxout(polinvrxout),
				.txcomplianceout(txcomplianceout),
				.xgmdataintoporbottom(xgmdataintoporbottom),
				.detectrxloopin(detectrxloopin),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_common_pcs_pma_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_common_pcs_pma_interface
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_common_pcs_pma_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_common_pcs_pma_interface_encrypted_ES #(
				...
				.func_mode(func_mode)
			) arriavgz_hssi_common_pcs_pma_interface_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_common_pcs_pma_interface_encrypted #(
				.ppm_deassert_early(ppm_deassert_early),
				.auto_speed_ena(auto_speed_ena),
				.pcie_gen3_cap(pcie_gen3_cap),
				.pipe_if_g3pcs(pipe_if_g3pcs),
				...
				.pma_if_dft_val(pma_if_dft_val),
				.func_mode(func_mode)
			) arriavgz_hssi_common_pcs_pma_interface_encrypted_inst (
				.agginsertincomplete0toporbot(agginsertincomplete0toporbot),
				.pcsaggtestbus(pcsaggtestbus),
				.pcsaggdecdatavalid(pcsaggdecdatavalid),
				.pcsgen3pmacurrentrxpreset(pcsgen3pmacurrentrxpreset),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_common_pld_pcs_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_common_pld_pcs_interface
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_common_pld_pcs_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_common_pld_pcs_interface_encrypted_ES #(
			...
			) arriavgz_hssi_common_pld_pcs_interface_encrypted_ES_inst (
				.pcs8gltr(pcs8gltr),
		...
		begin
			arriavgz_hssi_common_pld_pcs_interface_encrypted #(
				.pld_side_reserved_source9(pld_side_reserved_source9),
				.usrmode_sel4rst(usrmode_sel4rst),
				.pld_side_reserved_source0(pld_side_reserved_source0),
				.pld_side_reserved_source5(pld_side_reserved_source5),
				...
				.pld_side_reserved_source7(pld_side_reserved_source7),
				.emsip_enable(emsip_enable)
			) arriavgz_hssi_common_pld_pcs_interface_encrypted_inst (
				.pcs8gltr(pcs8gltr),
				.pcsgen3rate(pcsgen3rate),
				.pcs10gextraout(pcs10gextraout),
				.pld8grxvalid(pld8grxvalid),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_gen3_rx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_gen3_rx_pcs
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_gen3_rx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_gen3_rx_pcs_encrypted_ES #(
			...
			) arriavgz_hssi_gen3_rx_pcs_encrypted_ES_inst (
				.txpth(txpth),
				.avmmclk(avmmclk),
		...
		begin
			arriavgz_hssi_gen3_rx_pcs_encrypted #(
				.rmfifo_full_data(rmfifo_full_data),
				.rx_test_out_sel(rx_test_out_sel),
				.reverse_lpbk(reverse_lpbk),
				.mode(mode),
				...
				.rx_num_fixed_pat_data(rx_num_fixed_pat_data),
				.rmfifo_empty_data(rmfifo_empty_data)
			) arriavgz_hssi_gen3_rx_pcs_encrypted_inst (
				.txpth(txpth),
				.avmmclk(avmmclk),
				.lpbkdatavalid(lpbkdatavalid),
				.rxtestout(rxtestout),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_gen3_tx_pcs_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_gen3_tx_pcs
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_gen3_tx_pcs : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_gen3_tx_pcs_encrypted_ES #(
				.user_base_address(user_base_address),
			...
			) arriavgz_hssi_gen3_tx_pcs_encrypted_ES_inst (
				.datain(datain),
				.txpth(txpth),
				.avmmclk(avmmclk),
				.lpbkdatavalid(lpbkdatavalid),
		...
		begin
			arriavgz_hssi_gen3_tx_pcs_encrypted #(
				.tx_lane_num(tx_lane_num),
				.reverse_lpbk(reverse_lpbk),
				.mode(mode),
				.tx_clk_sel(tx_clk_sel),
				...
				.tx_bitslip(tx_bitslip),
				.tx_bitslip_data(tx_bitslip_data)
			) arriavgz_hssi_gen3_tx_pcs_encrypted_inst (
				.datain(datain),
				.txpth(txpth),
				.avmmclk(avmmclk),
				.lpbkdatavalid(lpbkdatavalid),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pipe_gen1_2_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pipe_gen1_2
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pipe_gen1_2 : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pipe_gen1_2_encrypted_ES #(
			...
			) arriavgz_hssi_pipe_gen1_2_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_pipe_gen1_2_encrypted #(
				.rpre_emph_d_val(rpre_emph_d_val),
				.rxdetect_bypass(rxdetect_bypass),
				.rvod_sel_a_val(rvod_sel_a_val),
				.phy_status_delay(phy_status_delay),
				...
				.tx_pipe_enable(tx_pipe_enable),
				.rpre_emph_e_val(rpre_emph_e_val)
			) arriavgz_hssi_pipe_gen1_2_encrypted_inst (
				.txelecidlecomp(txelecidlecomp),
				.pipetxclk(pipetxclk),
				.txdeemph(txdeemph),
				.pcieswitch(pcieswitch),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pipe_gen3_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pipe_gen3
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pipe_gen3 : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pipe_gen3_encrypted_ES #(
			...
			) arriavgz_hssi_pipe_gen3_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_pipe_gen3_encrypted #(
				.ph_fifo_reg_mode(ph_fifo_reg_mode),
				.phfifo_flush_wait_data(phfifo_flush_wait_data),
				.bypass_rx_preset_data(bypass_rx_preset_data),
				.mode(mode),
				...
				.spd_chnge_g2_sel(spd_chnge_g2_sel),
				.parity_chk_ts1(parity_chk_ts1)
			) arriavgz_hssi_pipe_gen3_encrypted_inst (
				.revlpbk8gpcsout(revlpbk8gpcsout),
				.rxdataskipint(rxdataskipint),
				.rxstatus(rxstatus),
				.clkcompoverflint(clkcompoverflint),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_cdr_att_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_cdr_att
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_cdr_att : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_cdr_att_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
				...
				.reference_clock_frequency(reference_clock_frequency),
				.hs_levshift_power_supply_setting(hs_levshift_power_supply_setting)
			) arriavgz_hssi_pma_cdr_att_encrypted_ES_inst (
				.fref(fref),
				.ck0pd(ck0pd),
				.ltd(ltd),
				.txrlpbk(txrlpbk),
		...
		begin
			arriavgz_hssi_pma_cdr_att_encrypted #(
                .enable_debug_info(enable_debug_info),
                .refclk_sel(refclk_sel),
				.pd_l_counter(pd_l_counter),
				.rxpll_pd_bw_ctrl(rxpll_pd_bw_ctrl),
				...
				.bypass_cp_rgla(bypass_cp_rgla),
				.force_vco_const(force_vco_const)
			) arriavgz_hssi_pma_cdr_att_encrypted_inst (
				.fref(fref),
				.ck0pd(ck0pd),
				.pldclkatt(pldclkatt),
				.ltd(ltd),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_deser_att_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_deser_att
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_deser_att : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_deser_att_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
				.vcobypass(vcobypass)
			) arriavgz_hssi_pma_deser_att_encrypted_ES_inst (
				.clkdivrx(clkdivrx),
				.avmmclk(avmmclk),
		...
		begin
			arriavgz_hssi_pma_deser_att_encrypted #(
                .enable_debug_info(enable_debug_info),
				.vcobypass(vcobypass)
			) arriavgz_hssi_pma_deser_att_encrypted_inst (
				.clkdivrx(clkdivrx),
				.avmmclk(avmmclk),
				.devenadiv2n(devenadiv2n),
				.div2270n(div2270n),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_rx_att_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_rx_att
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_rx_att : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_rx_att_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
				.var_bulk1(var_bulk1),
				.vcm_pdnb(vcm_pdnb),
			...
			) arriavgz_hssi_pma_rx_att_encrypted_ES_inst (
				.rdlpbkp(rdlpbkp),
				.avmmclk(avmmclk),
		...
		begin
			arriavgz_hssi_pma_rx_att_encrypted #(
                .enable_debug_info(enable_debug_info),
				.var_bulk1(var_bulk1),
				.vcm_pdnb(vcm_pdnb),
				.offcomp_cmref(offcomp_cmref),
				...
				.var_gate0(var_gate0),
				.offset_cancellation_ctrl(offset_cancellation_ctrl)
			) arriavgz_hssi_pma_rx_att_encrypted_inst (
				.rdlpbkp(rdlpbkp),
				.avmmclk(avmmclk),
				.rxnbidirin(rxnbidirin),
				.avmmrstn(avmmrstn),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_rx_buf_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_rx_buf
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_rx_buf : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_rx_buf_encrypted_ES #(
			...
			) arriavgz_hssi_pma_rx_buf_encrypted_ES_inst (
				.datain(datain),
				.rxrefclk(rxrefclk),
				.rdlpbkp(rdlpbkp),
				.avmmclk(avmmclk),
		...
		begin
			arriavgz_hssi_pma_rx_buf_encrypted #(
				.sd_threshold(sd_threshold),
				.dfe_pi_bw(dfe_pi_bw),
				.vcm_sel(vcm_sel),
				.vcm_current_add(vcm_current_add),
			...
			) arriavgz_hssi_pma_rx_buf_encrypted_inst (
				.datain(datain),
				.rxrefclk(rxrefclk),
				.rdlpbkp(rdlpbkp),
				.avmmclk(avmmclk),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_rx_deser_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_rx_deser
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_rx_deser : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_rx_deser_encrypted_ES #(
				.user_base_address(user_base_address),
			...
			) arriavgz_hssi_pma_rx_deser_encrypted_ES_inst (
				.fref(fref),
				.clkdivrx(clkdivrx),
		...
		begin
			arriavgz_hssi_pma_rx_deser_encrypted #(
				.user_base_address(user_base_address),
				.deser_div33_enable(deser_div33_enable),
				.channel_number(channel_number),
				.vco_bypass(vco_bypass),
				...
				.enable_bit_slip(enable_bit_slip),
				.sdclk_enable(sdclk_enable)
			) arriavgz_hssi_pma_rx_deser_encrypted_inst (
				.fref(fref),
				.clkdivrx(clkdivrx),
				.clkdivrxrx(clkdivrxrx),
				.avmmclk(avmmclk),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_ser_att_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_ser_att
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_ser_att : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_ser_att_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
				.ser_loopback(ser_loopback),
				.ser_pdb(ser_pdb)
			) arriavgz_hssi_pma_ser_att_encrypted_ES_inst (
				.datain(datain),
		...
		begin
			arriavgz_hssi_pma_ser_att_encrypted #(
                .enable_debug_info(enable_debug_info),
				.ser_loopback(ser_loopback),
				.ser_pdb(ser_pdb)
			) arriavgz_hssi_pma_ser_att_encrypted_inst (
				.datain(datain),
				.observableasyncdatain(observableasyncdatain),
				.lbvon(lbvon),
				.clk0(clk0),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_tx_att_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_tx_att
#(
    parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_tx_att : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_tx_att_encrypted_ES #(
                .enable_debug_info(enable_debug_info),
			...
			) arriavgz_hssi_pma_tx_att_encrypted_ES_inst (
				.devenbout(devenbout),
				.rxrlpbkn(rxrlpbkn),
				.avmmclk(avmmclk),
				.avmmrstn(avmmrstn),
		...
		begin
			arriavgz_hssi_pma_tx_att_encrypted #(
                .enable_debug_info(enable_debug_info),
				.main_driver_switch_en_2(main_driver_switch_en_2),
				.pre_emp_ctrl_post_tap_level(pre_emp_ctrl_post_tap_level),
				.post_tap_lowpass_filter_en_1(post_tap_lowpass_filter_en_1),
				...
				.main_driver_switch_en_0(main_driver_switch_en_0),
				.common_mode_driver_sel(common_mode_driver_sel)
			) arriavgz_hssi_pma_tx_att_encrypted_inst (
				.devenbout(devenbout),
				.rxrlpbkn(rxrlpbkn),
				.avmmclk(avmmclk),
				.avmmrstn(avmmrstn),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_tx_buf_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_tx_buf
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_tx_buf : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_tx_buf_encrypted_ES #(
			...
			) arriavgz_hssi_pma_tx_buf_encrypted_ES_inst (
				.vrlpbkp(vrlpbkp),
		...
		begin
			arriavgz_hssi_pma_tx_buf_encrypted #(
				.pre_emp_switching_ctrl_2nd_post_tap(pre_emp_switching_ctrl_2nd_post_tap),
				.rx_det_output_sel(rx_det_output_sel),
				.vcm_current_addl(vcm_current_addl),
				.term_sel(term_sel),
				...
				.pre_emp_switching_ctrl_1st_post_tap(pre_emp_switching_ctrl_1st_post_tap),
				.slew_rate_ctrl(slew_rate_ctrl)
			) arriavgz_hssi_pma_tx_buf_encrypted_inst (
				.vrlpbkp(vrlpbkp),
				.txqpipulldn(txqpipulldn),
				.datain(datain),
				.txelecidl(txelecidl),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_tx_cgb_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_tx_cgb
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_tx_cgb : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_tx_cgb_encrypted_ES #(
			...
			) arriavgz_hssi_pma_tx_cgb_encrypted_ES_inst (
				.pclkx6dn(pclkx6dn),
				.pclk(pclk),
				.pciesyncp(pciesyncp),
		...
		begin
			arriavgz_hssi_pma_tx_cgb_encrypted #(
				.x1_clock4_logical_to_physical_mapping(x1_clock4_logical_to_physical_mapping),
				.x1_div_m_sel(x1_div_m_sel),
				.mode(mode),
				.x1_clock2_logical_to_physical_mapping(x1_clock2_logical_to_physical_mapping),
				...
				.x1_clock3_logical_to_physical_mapping(x1_clock3_logical_to_physical_mapping),
				.x1_clock6_logical_to_physical_mapping(x1_clock6_logical_to_physical_mapping)
			) arriavgz_hssi_pma_tx_cgb_encrypted_inst (
				.pclkx6dn(pclkx6dn),
				.pclk(pclk),
				.pciesyncp(pciesyncp),
				.pcieswdone(pcieswdone),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_tx_ser_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_tx_ser
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
	parameter channel_number = 0,      // Valid values: 0..65
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_tx_ser : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_tx_ser_encrypted_ES #(
				.user_base_address(user_base_address),
				.channel_number(channel_number),
			...
			) arriavgz_hssi_pma_tx_ser_encrypted_ES_inst (
				.datain(datain),
				.hfclk(hfclk),
				.lbvon(lbvon),
				.cpulse(cpulse),
		...
		begin
			arriavgz_hssi_pma_tx_ser_encrypted #(
				.user_base_address(user_base_address),
				.channel_number(channel_number),
				.clk_divtx_deskew(clk_divtx_deskew),
				.mode(mode),
				...
				.avmm_group_channel_index(avmm_group_channel_index),
				.post_tap_1_en(post_tap_1_en)
			) arriavgz_hssi_pma_tx_ser_encrypted_inst (
				.datain(datain),
				.hfclk(hfclk),
				.lbvon(lbvon),
				.cpulse(cpulse),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_rx_pcs_pma_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_rx_pcs_pma_interface
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_rx_pcs_pma_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_rx_pcs_pma_interface_encrypted_ES #(
				.user_base_address(user_base_address),
				.prot_mode(prot_mode),
				.avmm_group_channel_index(avmm_group_channel_index),
				.selectpcs(selectpcs),
			...
			) arriavgz_hssi_rx_pcs_pma_interface_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_rx_pcs_pma_interface_encrypted #(
				.user_base_address(user_base_address),
				.prot_mode(prot_mode),
				.avmm_group_channel_index(avmm_group_channel_index),
				.selectpcs(selectpcs),
				.use_default_base_address(use_default_base_address),
				.clkslip_sel(clkslip_sel)
			) arriavgz_hssi_rx_pcs_pma_interface_encrypted_inst (
				.pmarxpllphaselockout(pmarxpllphaselockout),
				.pcsgen3eyemonitorin(pcsgen3eyemonitorin),
				.dataouttogen3pcs(dataouttogen3pcs),
				.pcs8gsigdetni(pcs8gsigdetni),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_rx_pld_pcs_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_rx_pld_pcs_interface
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
	parameter data_source = "pld",      // Valid values: emsip|pld
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_rx_pld_pcs_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_rx_pld_pcs_interface_encrypted_ES #(
				.user_base_address(user_base_address),
				.data_source(data_source),
			...
			) arriavgz_hssi_rx_pld_pcs_interface_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_rx_pld_pcs_interface_encrypted #(
				.user_base_address(user_base_address),
				.data_source(data_source),
				.is_10g_0ppm(is_10g_0ppm),
				.avmm_group_channel_index(avmm_group_channel_index),
				...
				.use_default_base_address(use_default_base_address),
				.is_8g_0ppm(is_8g_0ppm)
			) arriavgz_hssi_rx_pld_pcs_interface_encrypted_inst (
				.pcs8gbytordpld(pcs8gbytordpld),
				.pld10grxalignval(pld10grxalignval),
				.pldrxclkslipin(pldrxclkslipin),
				.pcs8gphfifourstrx(pcs8gphfifourstrx),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_tx_pcs_pma_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_tx_pcs_pma_interface
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
	parameter avmm_group_channel_index = 0,      // Valid values: 0..2
	parameter selectpcs = "eight_g_pcs",      // Valid values: eight_g_pcs|ten_g_pcs|pcie_gen3|default
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_tx_pcs_pma_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_tx_pcs_pma_interface_encrypted_ES #(
				.user_base_address(user_base_address),
				.avmm_group_channel_index(avmm_group_channel_index),
				.selectpcs(selectpcs),
				.use_default_base_address(use_default_base_address)
			) arriavgz_hssi_tx_pcs_pma_interface_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_tx_pcs_pma_interface_encrypted #(
				.user_base_address(user_base_address),
				.avmm_group_channel_index(avmm_group_channel_index),
				.selectpcs(selectpcs),
				.use_default_base_address(use_default_base_address)
			) arriavgz_hssi_tx_pcs_pma_interface_encrypted_inst (
				.pmaclkdiv33lcout(pmaclkdiv33lcout),
				.asynchdatain(asynchdatain),
				.pmatxclkout(pmatxclkout),
				.avmmclk(avmmclk),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_tx_pld_pcs_interface_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_tx_pld_pcs_interface
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
	parameter data_source = "pld",      // Valid values: emsip|pld
	parameter is_10g_0ppm = "false",      // Valid values: false|true
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_tx_pld_pcs_interface : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_tx_pld_pcs_interface_encrypted_ES #(
				.user_base_address(user_base_address),
				.data_source(data_source),
				.is_10g_0ppm(is_10g_0ppm),
				.avmm_group_channel_index(avmm_group_channel_index),
				.use_default_base_address(use_default_base_address),
				.is_8g_0ppm(is_8g_0ppm)
			) arriavgz_hssi_tx_pld_pcs_interface_encrypted_ES_inst (
		...
		begin
			arriavgz_hssi_tx_pld_pcs_interface_encrypted #(
				.user_base_address(user_base_address),
				.data_source(data_source),
				.is_10g_0ppm(is_10g_0ppm),
				.avmm_group_channel_index(avmm_group_channel_index),
				.use_default_base_address(use_default_base_address),
				.is_8g_0ppm(is_8g_0ppm)
			) arriavgz_hssi_tx_pld_pcs_interface_encrypted_inst (
				.pld10gtxpfull(pld10gtxpfull),
				.pcs8gpolinvtx(pcs8gpolinvtx),
				.pmatxlcplllock(pmatxlcplllock),
				.pldgen3txrstn(pldgen3txrstn),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_refclk_divider_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_refclk_divider
#(
	parameter user_base_address = 0,      // Valid values: 0..2047
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_refclk_divider : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_refclk_divider_encrypted_ES #(
				.user_base_address(user_base_address),
				.divide_by(divide_by),
				.avmm_group_channel_index(avmm_group_channel_index),
				.use_default_base_address(use_default_base_address),
				...
				.enabled(enabled),
				.reference_clock_frequency(reference_clock_frequency)
			) arriavgz_hssi_refclk_divider_encrypted_ES_inst (
				.refclkin(refclkin),
				.refclkout(refclkout),
				.blockselect(blockselect),
				.avmmreaddata(avmmreaddata),
		...
		begin
			arriavgz_hssi_refclk_divider_encrypted #(
				.user_base_address(user_base_address),
				.divide_by(divide_by),
				.avmm_group_channel_index(avmm_group_channel_index),
				.use_default_base_address(use_default_base_address),
				...
				.enabled(enabled),
				.reference_clock_frequency(reference_clock_frequency)
			) arriavgz_hssi_refclk_divider_encrypted_inst (
				.refclkin(refclkin),
				.refclkout(refclkout),
				.blockselect(blockselect),
				.avmmreaddata(avmmreaddata),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : arriavgz_hssi_pma_cdr_refclk_select_mux_wrapper_multirev.v
// --------------------------------------------------------------------


`timescale 1 ps/1 ps
module arriavgz_hssi_pma_cdr_refclk_select_mux
#(
...
(
	...
	initial
	begin
		$display("module arriavgz_hssi_pma_cdr_refclk_select_mux : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			arriavgz_hssi_pma_cdr_refclk_select_mux_encrypted_ES #(
			...
			) arriavgz_hssi_pma_cdr_refclk_select_mux_encrypted_ES_inst (
				.refclklc(refclklc),
				.occalen(occalen),
				.refiqclk2(refiqclk2),
				.rxiqclk7(rxiqclk7),
		...
		begin
			arriavgz_hssi_pma_cdr_refclk_select_mux_encrypted #(
				.inclk20_logical_to_physical_mapping(inclk20_logical_to_physical_mapping),
				.inclk3_logical_to_physical_mapping(inclk3_logical_to_physical_mapping),
				.inclk23_logical_to_physical_mapping(inclk23_logical_to_physical_mapping),
				.inclk8_logical_to_physical_mapping(inclk8_logical_to_physical_mapping),
				...
				.inclk19_logical_to_physical_mapping(inclk19_logical_to_physical_mapping),
				.inclk11_logical_to_physical_mapping(inclk11_logical_to_physical_mapping)
			) arriavgz_hssi_pma_cdr_refclk_select_mux_encrypted_inst (
				.refclklc(refclklc),
				.occalen(occalen),
				.refiqclk2(refiqclk2),
				.rxiqclk7(rxiqclk7),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : ./sim_model_wrappers//arriavgz_hssi_pma_lc_refclk_select_mux_wrapper.v
// --------------------------------------------------------------------

`timescale 1 ps/1 ps
module arriavgz_hssi_pma_lc_refclk_select_mux
#(
	// parameter declaration and default value assignemnt
	parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
//input and output port declaration
	...
	arriavgz_hssi_pma_lc_refclk_select_mux_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriavgz_hssi_pma_lc_refclk_select_mux_encrypted_inst	(
		.avmmaddress(avmmaddress),
		.avmmbyteen(avmmbyteen),
		.avmmrstn(avmmrstn),
		.avmmclk(avmmclk),
...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : ./sim_model_wrappers//arriavgz_lc_pll_wrapper.v
// --------------------------------------------------------------------

`timescale 1 ps/1 ps

//`define USE_ICD_LC_MODEL
module arriavgz_atx_pll
#(
	// parameter declaration and default value assignemnt
	parameter enable_debug_info = "false",	//Valid values: false|true; this is simulation-only parameter, for debug purpose only
...
//input and output port declaration
	...
	generate
		...
		//begin
			...
			arriavgz_atx_pll_encrypted_inst	(
				.avmmaddress(avmmaddress),
				.avmmbyteen(avmmbyteen),
				.avmmclk(avmmclk),
				.avmmread(avmmread),
