...
parameter inclk25_logical_to_physical_mapping = "";
    ...
    arriav_hssi_pma_cdr_refclk_select_mux_encrypted  
    #(
    .lpm_type(lpm_type),
    .channel_number(channel_number),
...
module arriav_hssi_refclk_divider 
  ...
  input    [0:0]       nonuserfrompmaux
	...
	arriav_hssi_refclk_divider_encrypted 
		#(
			.lpm_type(lpm_type),
			.divide_by(divide_by),
			.enabled(enabled),
	...
	arriav_hssi_refclk_divider_encrypted_inst (
			.refclkin(refclkin),
			.refclkout(refclkout),
			.nonuserfrompmaux(nonuserfrompmaux)
		);
...
//input and output port declaration
  ...
  arriav_hssi_avmm_interface_encrypted
  #(
...
module arriav_hssi_pma_hi_pmaif
  ...
  (
   ...
   // ... avmm and block select ports go here ...
    ...
    arriav_hssi_pma_hi_pmaif_encrypted 
    # (
...
module arriav_hssi_pma_hi_xcvrif
  ...
  (
   ...
   // ... avmm and block select ports go here ...
    ...
    arriav_hssi_pma_hi_xcvrif_encrypted 
    # (
